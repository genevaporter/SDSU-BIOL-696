...
if [ -d ".BACKUP_FILES/" ] 
then
    "Directory ~/biol696-1/BACKUP_FILES exists." 
else
    echo "Directory ~/biol696-1/BACKUP_FILES does not exist..."
    mkdir ~/biol696-1/BACKUP_FILES/ 
    echo "Created BACKUP_FILES in ~/biol696-1 directory"
fi
...
print_info () {
    ls -al ~/biol696-1/BACKUP_FILES/
    du -sh ~/biol696-1/BACKUP_FILES/
}
